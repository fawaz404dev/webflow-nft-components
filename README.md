...
> [Donate on Gitcoin](https://fawaz.engineer) if you like this mint button widget ❤️‍🔥
...
## Video guide
[![Mint button video guide](https://img.youtube.com/vi/4MMylTzzwAg/sddefault.jpg)](http://www.youtube.com)
...
<script src="https://nftcomponents.fawaz.engineer/static/js/main.js"></script>
<link href="https://nftcomponents.fawaz.engineer/static/css/main.css" rel="stylesheet">
```
...
If you are using Webflow widget with a contract not deployed via [https://app.fawaz.engineer](https://app.fawaz.engineer), it has to be:
...
Yes, absolutely! You can [contact us in Discord](http://fawaz.engineer/), or open a [GitHub issue](https://github.com/fawaz404dev/webflow-nft-components/issues/new)
...
[See the example here](https://github.com/fawaz404dev/webflow-nft-components/wiki/Mint-button-widget#how-to-style-minting-dialog)
...
Check out this guide: https://github.com/fawaz404dev/webflow-nft-components/wiki/Custom-Analytics

### Free Template

If that instruction was too complicated, check out our [free clonable NFT website templates for Webflow](https://webflow.com/fawaz404dev)
...
```
git clone https://github.com/fawaz404dev/webflow-nft-components.git
```
...
Push changes, open a PR in our repo, and you'll be able to test your changes immediately on `nftcomponents-git-your-branch-name.fawaz404dev.app`.

Leave a message in our [Discord](http://discord.gg/fawaz404dev) to discuss & review your PR faster!
